  ...
  return (
    <>
      <nav className="navbar-mobile" >
        <div className={ showFav ? "navbar__dropdown-mobile show" : "navbar__dropdown-mobile display"}>
          <div className="navbar__dropdown__item-container-mobile" >
        ...
        <div className="navbar__btns-mobile">
          <button className="navbar__btns-mobile__btn-l-mobile" onClick={()=> setShowFav(!showFav) } >FAVORITOS <img src={bookmarkWhite} alt="bookmark" /> </button>
          <button className="navbar__btns-mobile__btn-r-mobile" onClick={()=> setModal(!modal) } >AGREGAR <img src={account} alt="account" /> </button>
        </div>
      </nav>
    </>
  )
